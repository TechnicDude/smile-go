...
import '../../../utils/loaderscreennew.dart';

class DoctorDetailsScreenActivity extends StatefulWidget {
  final TopdoctorslistData doctordetails;
  final String doctorName;

  const DoctorDetailsScreenActivity(
      {super.key, required this.doctordetails, required this.doctorName});

  @override
  State<DoctorDetailsScreenActivity> createState() =>
      _DoctorDetailsScreenActivityState();
}

class _DoctorDetailsScreenActivityState
    extends State<DoctorDetailsScreenActivity> {
  DoctorDetailsProvider detailsProvider = DoctorDetailsProvider();
  ...
  void initState() {
    ...
    detailsProvider.singleDoctorDetails(widget.doctordetails.id.toString());
    super.initState();
  }
        ...
        : Consumer<DoctorDetailsProvider>(
            ...
            return Scaffold(
              floatingActionButton: ButtonWidgetCou(
                text: Languages.of(context)!.bookappointment,
                onTap: () {
                  Navigator.pushNamed(
                    context,
                    Routes.rescheduleAppointmentDate,
                    arguments: {
                      AppStringFile.doctordetails: widget.doctordetails,
                    },
                  );
                },
              ),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.doctordetails.doctorProfiles != null
                                  ? widget.doctordetails.doctorProfiles!
                                      .professionalBio!
                                  : '',
                            ),
                            ...
                            Text(
                              Languages.of(context)!.workingtime,
                              style: AppStyles.onboardtitle
                                  .copyWith(fontSize: 16.sp),
                            ),
                            SizedBox(
                            ...
                            Text(
                              widget.doctordetails.locationDetail != null
                                  ? widget.doctordetails.locationDetail!.pincode
                                      .toString()
                                  : '',
                              style: AppStyles.onboardbody,
                            ),
